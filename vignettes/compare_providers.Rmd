...
This code uses the raw rate data (instead of the standardized ratio). The confidence intervals the funnels represent can be adjusted. An arbitrary number of funnels can be plotted in the same figure.
...
Sorted control charts are easier to read and obscure the volume, something that may be useful to maintain a level of anonymity ( https://www.doi.org/10.1371/journal.pone.0242656 ).
